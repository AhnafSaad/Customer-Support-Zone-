...
Bash npm run dev Open in Browser: Navigate to http://localhost:5173 in your web browser to see the application running.

📁 Project Structure Overview src/components/ - Contains all reusable React components (Navbar, Banner, TicketList, TicketDetailsModal, etc.).
